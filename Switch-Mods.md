...
| Mod | Description | Applies to | Credit |
| --- | ----------- | ---------- | ------ |
| [Forced 1080p, 60 FPS, Increased LOD, Disabled Ambient Occlusion](https://cdn.discordapp.com/attachments/495758692495523854/910317406843461632/Config_SMTV_1080p.zip) | Varied config changes for SMTV, the main points of which being a forcibly increased resolution (works in cutscenes), 60 FPS, increased draw distance and disabled ambient occlusion (responsible for weird dithered-looking shadows). | `1.0.0` `1.0.1` | TheHatedGravity
